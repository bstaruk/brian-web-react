...
const baseButtonClasses =
  'cursor-pointer font-medium uppercase text-shadow-xs p-2 bg-monster-600 text-monster-50 hover:underline rounded-xs shadow-xs font-sans text-base outline-0 hover:bg-monster-700 focus:bg-monster-700';
