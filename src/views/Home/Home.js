  ...
  render() {
    ...
    return (
      <Content>
        ...
        <p>...and it was built with <a onClick={this.handleOverlayToggle.bind(this, 'skillOverlayReact', true)} href="#">React</a>! Check out <a href="https://github.com/bstaruk/brian-web-react" target="_blank" className="icon-after external">the GitHub repo</a>.</p>
