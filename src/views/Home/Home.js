  ...
  render() {
    ...
    return (
      <Content>
        ...
        <p>Check out my resume at <a href="http://resume.brian.staruk.me" target="_blank">resume.brian.staruk.me</a> if you'd like to learn more about what I've been up to.</p>
      </Content>
    );
  }
}
